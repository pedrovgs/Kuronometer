...
import com.github.pedrovgs.kuronometer.free.interpreter.{Interpreters, ReporterInterpreter, Clock, ViewInterpreter}
...
object implicits {
  ...
  implicit def kuronometer = new Kuronometer()
}
