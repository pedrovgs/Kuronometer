...
import com.github.pedrovgs.kuronometer.free.domain.{BuildExecution, Report, SummaryBuildStagesExecution}

sealed trait ReporterOp[A]

final case class ReportBuildExecution(buildExecution: BuildExecution, report: Report) extends ReporterOp[KuronometerResult[BuildExecution]]
final case class GetTotalBuildExecution() extends ReporterOp[KuronometerResult[SummaryBuildStagesExecution]]
final case class GetTodayBuildExecution() extends ReporterOp[KuronometerResult[SummaryBuildStagesExecution]]
